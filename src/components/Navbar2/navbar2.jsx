...
const navigation = [
  { name: 'Inicio', href: '/ini2', current: true },
...
export default function Example() {
  return (
    <Disclosure as="nav" className="bg-D9D9D9 text-black" >
      {({ open }) => (
        <>
                    ...
                    {navigation.map((item) => (
                      <a
                        ...
                        className={classNames(
                          item.current ? 'bg-white text-black' : 'text-white hover:bg-blue-300 hover:text-black  ',
